    ...
    def __init__(self):
        ...
        self.role_prompts = {
            ...
            AgentTask.UI_BUILDER: '''
                You are a UI Generator Agent. Given a UI Blueprint, you must generate working HTML, CSS, JS code with highly interactive components. The component should allow users to input data, call the model API, and display the output results as specified.
