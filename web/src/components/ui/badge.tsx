...
const badgeVariants = cva(
  "inline-flex items-center text-white rounded-md border px-2.5 py-0.5 text-xs font-montserrat font-bold transition-colors focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2",
  {
    variants: {
      variant: {
